...
MODEL_ID = os.getenv("BEDROCK_MODEL_ID", "apac.anthropic.claude-3-5-sonnet-20241022-v2:0")  # ?쒖슱 由ъ쟾 吏??紐⑤뜽
BEDROCK_REGION = os.getenv("BEDROCK_REGION", "ap-northeast-2")  # ?쒖슱 由ъ쟾
