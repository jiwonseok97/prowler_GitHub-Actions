...
# Alternatively, you can create a new launch template that uses the new security group
resource "aws_launch_template" "remediation_lt" {
  name = "remediation-lt"

  vpc_security_group_ids = [aws_security_group.remediation_sg.id]

  # Other launch template configuration as needed
}
