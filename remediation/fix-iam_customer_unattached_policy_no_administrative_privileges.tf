...
# Set the newly created policy version as the default version
...
4. Sets the newly created policy version as the default version of the `aws_learner_dynamodb_policy`.
