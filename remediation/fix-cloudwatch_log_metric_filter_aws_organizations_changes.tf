...
2. Creates a CloudWatch Logs metric filter for AWS Organizations changes. The filter looks for events with the `eventSource` field equal to `organizations.amazonaws.com`.
