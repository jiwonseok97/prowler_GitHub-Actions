...
4. Creates a CloudWatch alarm for the unauthorized API calls metric, which will trigger when the metric value is greater than or equal to 1. The alarm action is set to an SNS topic for security notifications.