...
resource "aws_cloudwatch_metric_alarm" "unauthorized_api_calls" {
  ...
  alarm_actions       = ["arn:aws:sns:ap-northeast-2:132410971304:my-security-alert-topic"]
}
...
4. Creates a CloudWatch alarm for the unauthorized API calls metric, with the following settings:
   ...
   - Alarm actions: `arn:aws:sns:ap-northeast-2:132410971304:my-security-alert-topic`
