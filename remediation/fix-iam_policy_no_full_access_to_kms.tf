...
3. Creates a new version of the IAM policy with reduced KMS permissions, allowing only the necessary actions (`kms:Encrypt`, `kms:Decrypt`, `kms:ReEncrypt*`, `kms:GenerateDataKey*`, and `kms:DescribeKey`) and scoping the permissions to the specific KMS key ARN.