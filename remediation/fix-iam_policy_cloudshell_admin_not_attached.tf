...
resource "aws_iam_policy_attachment" "remove_cloudshell_admin" {
  ...
  users      = data.aws_iam_policy_attachment.cloudshell_admin.users
  groups     = data.aws_iam_policy_attachment.cloudshell_admin.groups
  roles      = data.aws_iam_policy_attachment.cloudshell_admin.roles
}
