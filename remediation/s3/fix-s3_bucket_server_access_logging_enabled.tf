...
# Apply a bucket policy to the log bucket to allow the log delivery write access
...
variable "s3_bucket_name" {
  description = "Name of the S3 bucket with the server access logging finding"
  type        = string
