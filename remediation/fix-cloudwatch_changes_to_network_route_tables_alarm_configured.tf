...
3. Creates a CloudWatch alarm that triggers when the "VPCRouteTableChanges" metric is greater than or equal to 1, indicating that a route table change has been detected. The alarm is configured to send notifications to an SNS topic with the ARN `arn:aws:sns:ap-northeast-2:132410971304:my-security-topic`.
