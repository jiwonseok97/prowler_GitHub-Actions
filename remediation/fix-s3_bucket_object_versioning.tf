...
4. Applies a lifecycle rule to manage noncurrent versions using the `aws_s3_bucket_lifecycle_configuration` resource. This rule will delete noncurrent versions after 30 days.