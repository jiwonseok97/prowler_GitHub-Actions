...
3. Creates a CloudWatch alarm for the root account usage metric filter. The alarm is triggered when the sum of the "RootUsage" metric is greater than or equal to 1 within a 60-second period. When the alarm is triggered, it sends a notification to the "arn:aws:sns:ap-northeast-2:132410971304:my-alert-topic" SNS topic.