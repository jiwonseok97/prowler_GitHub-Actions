...
This should address the security finding by ensuring that the EC2 instance is associated with an IAM instance profile role, which can be used to grant the instance the required permissions.