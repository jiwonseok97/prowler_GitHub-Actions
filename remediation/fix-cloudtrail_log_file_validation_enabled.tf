...
4. The rest of the attributes are copied from the existing CloudTrail trail to ensure that the updated trail has the same configuration as the original.