...
resource "aws_kms_key" "aws_cloudtrail_logs_key" {
  description             = "Customer-managed KMS key for aws-cloudtrail-logs-132410971304-0971c04b S3 bucket"
...
5. Adds a bucket policy to enforce KMS encryption for all objects uploaded to the S3 bucket.