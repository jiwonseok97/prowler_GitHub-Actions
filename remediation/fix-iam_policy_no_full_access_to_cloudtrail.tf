...
This should address the security finding by applying the principle of least privilege and allowing only the necessary CloudTrail actions, instead of granting full `cloudtrail:*` access.