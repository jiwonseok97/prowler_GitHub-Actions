...
4. Applies the `bucket-owner-full-control` ACL to the S3 bucket using the `aws_s3_bucket_acl` resource, which depends on the `aws_s3_bucket_ownership_controls` resource to ensure the ownership controls are in place before applying the ACL.