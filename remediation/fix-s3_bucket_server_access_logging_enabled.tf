...
# Add a CloudTrail trail to capture object-level events
...
4. Adds a CloudTrail trail to capture object-level events, and stores the logs in the same log bucket.