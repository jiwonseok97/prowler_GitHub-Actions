...
# Create a new security group with reduced inbound and outbound rules
...
3. Creates a new security group with reduced inbound and outbound rules, following the recommendation:
...
4. Applies a name prefix to the new security group for easier identification.