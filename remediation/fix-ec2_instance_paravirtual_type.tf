...
resource "aws_instance" "new_instance" {
  ...
  ebs_optimized         = true
  monitoring            = true
  iam_instance_profile  = "my-instance-profile" # Replace with a suitable IAM instance profile
  user_data             = file("user_data.sh")  # Replace with your custom user data script
