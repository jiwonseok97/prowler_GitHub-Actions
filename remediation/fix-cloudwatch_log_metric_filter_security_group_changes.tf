...
Note that you will need to replace `YOUR_CLOUDTRAIL_LOG_GROUP_NAME` with the name of your CloudTrail log group, and `YOUR_SNS_TOPIC_ARN` with the ARN of the SNS topic you want to use for the alarm notifications.