...
3. Creates a CloudWatch alarm that triggers when the "SecurityGroupChanges" metric has a value greater than or equal to 1. This will send an alert to the specified SNS topic when a security group change is detected.
