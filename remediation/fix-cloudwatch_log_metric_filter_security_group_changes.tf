...
3. Creates a CloudWatch alarm that triggers when the "SecurityGroupChanges" metric, as defined in the metric filter, is greater than or equal to 1. This alarm will send a notification to the specified SNR topic.
