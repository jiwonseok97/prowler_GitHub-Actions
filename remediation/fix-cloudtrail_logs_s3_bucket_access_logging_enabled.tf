...
# Update the CloudTrail trail to use the new S3 bucket for logs
...
5. Updates the existing CloudTrail trail to use the new S3 bucket for logs, and enables additional security features like log file validation.